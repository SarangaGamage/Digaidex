...
(function($) {
    ...
    var changeCheckView = function(element, checked) {
        ...
        if (checked === null) {
            ...
            //Shiham updated the bootstrap to use the new glyphicons
            element.html('<span class="glyphicon glyphicon-stop" aria-hidden="true"></span>');
        } else if (checked) {
            element.addClass('checked');
            //element.html('<i class="icon-ok"></i>');
            //Shiham updated the bootstrap to use the new glyphicons            
            element.html('<span class="glyphicon glyphicon-ok" aria-hidden="true"></span>');
        } else {
            element.html('');
        }
    };
